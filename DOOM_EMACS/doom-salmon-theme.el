...
(def-doom-theme doom-salmon
  "A dark theme inspired by VS Code Solarized Dark"

  ;; name        default   256       16
  ((bg         '("#ECE6DD" "#ECE6DD" "brightwhite" ))
   ...
   (base0      '("#D8C8B9" "#D8C8B9" "black"       ))
   (base1      '("#EADCCE" "#EADCCE" "brightblack" ))
   (base2      '("#19a902" "#19a902" "green" ))
   (base3      '("#d10a02" "#d10a02" "red" ))
   (base4      '("#d10a02" "#d10a02" "blue" ))
   (base5      '("#d15f1a" "#d15f1a" "orange" ))
   (base6      '("#ac1ed1" "#ac1ed1" "purple" ))
   (base7      '("#cad100" "#cad100" "yellow" ))
