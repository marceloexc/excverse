...
(set-face-attribute 'mode-line nil :font "Helvetica-14")
...
We will then install ~org-bullets~ for better bullets
...
(add-hook 'org-mode-hook #'+org-init-appearance-h)
#+end_src

Also make sure to use ~org-indent-mode~
