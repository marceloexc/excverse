...
Instead, we use a custom function that I got from here...
  ...
  (defun my-centaur-tabs-buffer-groups ()
    ...
    (list
     (cond
      ...
      ((member (buffer-name) '("*compile*" "*Minibuf-1*" "*dashboard*" "*Messages*" "*helm*" "*scratch*"  "*Async-native-compile-log*" "*Compile-Log*" "*xref*"))
       "Fundamental")
