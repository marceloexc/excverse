...
#+begin_src emacs-lisp
  (add-hook 'highlight-indentation-mode 'prog-mode)
#+end_src
  ...
  (defun +my--set-common-fonts (family height)
    ...
    (let* ((mode-line-box-color (face-background 'mode-line))
      ...
      (set-face-attribute 'mode-line nil
                          ...
                          :height height
                          :weight 'normal
                          :box mode-line-box-style) ; Use the determined style
      (set-face-attribute 'mode-line-inactive nil
                          :family family
                          :height height
                          :weight 'normal
                          :box mode-line-inactive-box-style) ; Use the determined style
