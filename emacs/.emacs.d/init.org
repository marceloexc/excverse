  ...
  (defun +my--set-common-fonts (family height)
    ...
    (let* ((mode-line-box-color (face-background 'mode-line))
        ...
        (if compact-mode
          ...
          (setq mode-line-box-style `(:line-width 7 :color ,mode-line-box-color :style nil)
                mode-line-inactive-box-style `(:line-width 7 :color ,mode-line-inactive-box-color :style nil)))
