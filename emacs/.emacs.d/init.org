...
use winpulse to pulse the active window
  ...
  (defun my-centaur-tabs-buffer-groups ()
    ...
    (list
     (cond
      ...
      ((member (buffer-name) '("*compile*" "*Minibuf-1*" "*dashboard*" "*Messages*" "*helm*" "*Async-native-compile-log*" "*Compile-Log*" "*xref*" "*httpd*" "magit-*" "*Completions*"))
       "Fundamental")
