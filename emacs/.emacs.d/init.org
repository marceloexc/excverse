...
#+begin_src emacs-lisp
  (defun my/dnd-get-local-file-name-relative (uri &optional must-exist)
    "Like `dnd-get-local-file-name', but returns relative paths when possible."
    ...
    (let* ((f
      ...
      f))
  (advice-add 'dnd-get-local-file-name :override #'my/dnd-get-local-file-name-relative)
#+end_src
* Visual
